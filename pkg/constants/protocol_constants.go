...
const (
	// 协议解析错误码
	ErrCodeInvalidHeader   = 1001 // 无效包头
	ErrCodeInvalidLength   = 1002 // 无效长度
	ErrCodeInvalidChecksum = 1003 // 校验和错误
	ErrCodeInvalidCommand  = 1004 // 无效命令
	ErrCodeInvalidData     = 1005 // 无效数据

	// 连接错误码
	ErrCodeConnectionLost    = 2001 // 连接丢失
	ErrCodeConnectionTimeout = 2002 // 连接超时
	ErrCodeConnectionRefused = 2003 // 连接被拒绝
	ErrCodeConnectionLimit   = 2004 // 连接数限制

	// 业务错误码
	ErrCodeDeviceNotFound   = 3001 // 设备未找到
	ErrCodeDeviceOffline    = 3002 // 设备离线
	ErrCodeInvalidOperation = 3003 // 无效操作
	ErrCodeOperationTimeout = 3004 // 操作超时
)
